...
% Last Modified by GUIDE v2.5 21-Dec-2022 16:01:47
...
% --- Executes on button press in do_enhance.
function do_enhance_Callback(hObject, eventdata, handles)
...
msgbox('Thank for using Image Enhancement Tool')
pause(3)
close all
Main_GUI
...
% Hints: get(hObject,'String') returns contents of outputimage as text
%        str2double(get(hObject,'String')) returns contents of outputimage as a double
